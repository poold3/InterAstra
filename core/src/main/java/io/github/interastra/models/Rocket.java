...
public abstract class Rocket implements CameraEnabledEntity {
    ...
    public static final Price[] ROCKET_TIER_PRICE = {
        ...
        new Price(350f, 500f, 0f, 50f, 25f, 0f),
        new Price(400f, 500f, 0f, 50f, 50f, 0f)
    };
    public static final Price[] ROCKET_TIER_FUEL_PRICE = {
        new Price(0f, 0f, 150f, 0f, 0f, 0f),
        new Price(0f, 0f, 250f, 0f, 0f, 0f),
        new Price(0f, 0f, 100f, 0f, 0f, 25f),
        new Price(0f, 0f, 100f, 0f, 0f, 50f)
    };
    public static final String[] ROCKET_TIER_STRING = {"I", "II", "III", "IV"};
    public static final RocketStats[] ROCKET_TIER_STATS = {
        new RocketStats(250f, 2f, 60f, ROCKET_TIER_PRICE[0].balance / 2f, 1f),
        new RocketStats(350f, 2.5f, 80f, ROCKET_TIER_PRICE[1].balance / 2f, 1.5f),
        new RocketStats(450f, 3f, 100f, ROCKET_TIER_PRICE[2].balance / 2f, 1.8f),
        new RocketStats(550f, 4f, 120f, ROCKET_TIER_PRICE[3].balance / 2f, 2f)
    };
